...
$sql = "select tcode as 'Ref No',dat as 'Date',nam as 'Name',accno as 'Connection No',ind  as 'Error Ind',telno as 'Tel No',amt as 'Amount',reg as 'Region' from mpesa where mdat='$dat' and reg='$reg' order by reg,tcode,accno desc"; 
