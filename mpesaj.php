 ...
 // document.getElementById("mm").innerHTML=str+" length="+cnt;
    ...
    //  alert(str);
     xmlhttp.onreadystatechange = function()
             ...
             var val=    document.getElementById("vall").value;
...
<td width=15%><input id="vall" type="text" name="dat"  onkeyup="clean()"  onclick="txtclicked()"></td><td width=15%><input type="button"   value="Query" onclick="getpage()"></td>
